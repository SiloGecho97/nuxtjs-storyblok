<template>
  <footer class="p-4 bg-gray-100 rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
    <div class="max-w-5xl mx-auto text-center">
      ...
      <br>
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" class="hover:underline">PlayRank™</a>. All Rights Reserved.
    </span>

<template>
  <header class="my-5 max-w-screen-xl w-full mx-auto">
      <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
          <nuxt-link to="/" class="flex items-center">
              <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
              <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">PlayRank</span>
          </nuxt-link>
          ...
          <div>
            <nuxt-link to="/" class="bg-gray-100 m-1">EN</nuxt-link>
            <nuxt-link to="/de" class="bg-gray-100 m-1">DE</nuxt-link>
            <nuxt-link to="/es" class="bg-gray-100 m-1">ES</nuxt-link>
